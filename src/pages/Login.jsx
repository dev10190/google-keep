  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center bg-blue-100 dark:bg-gray-700">
      <div
        ...
        className={`absolute top-5 right-5 text-sm py-1 px-2 rounded-md cursor-pointer border 
      ...
      <div className="bg-white p-12 rounded-lg w-[1024px] min-w-[500px] flex flex-col md:items-start items-center gap-5 dark:bg-gray-900 dark:text-white">
        ...
        <div className="flex md:flex-row flex-col md:items-start items-center  gap-10 w-full">
          <div className="w-[50%] flex flex-col md:items-start items-center">
            <p className="text-4xl font-medium pb-3 text-gray-800 dark:text-white">
              Sign in
            </p>
          ...
          >
            <div>
              ...
              <div>
                <p className="text-blue-800 pt-1 font-semibold text-md cursor-pointer text-right">
                  Forget email?
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-3 items-center">
              ...
              <Button
                type="submit"
                className="text-white hover:bg-blue-600 duration-500 cursor-pointer "
              >
                Log in
              </Button>
            </div>
